/// Provider-neutral failures exposed by the Services remote transport boundary.
enum ServiceRemoteDataSourceError: Error, Equatable {
...
extension ServiceRemoteDataSourceError {
...
/// Performs server-backed Services transport operations without exposing provider SDK types.
protocol ServiceRemoteDataSource: Sendable {
    /// Requests the bootstrap or incremental Services batch after a durable cursor.
    ///
