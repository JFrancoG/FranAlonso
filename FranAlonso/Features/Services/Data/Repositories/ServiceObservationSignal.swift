...
/// Invalidates observers after a known Services local commit.
protocol ServiceChangeSignaling: Sendable {
    func publishChange() async
}

/// Signals committed local Services changes to active repository observations.
///
...
actor ServiceObservationSignal: ServiceChangeSignaling {
