...
/// Invalidates observers after a known Products local commit.
protocol ProductChangeSignaling: Sendable {
    func publishChange() async
}

/// Signals committed local Products changes to active repository observations.
///
...
actor ProductObservationSignal: ProductChangeSignaling {
