...
/// Invalidates observers after a known Sales local commit.
protocol SaleChangeSignaling: Sendable {
    func publishChange() async
}

/// Signals committed local Sales changes to active repository observations.
///
...
actor SaleObservationSignal: SaleChangeSignaling {
