...
El propietario aceptó el ADR 0025 el 24 de agosto de 2026: añade dos errores deterministas de raíz, hace fail-closed
cualquier intención explícita de fixture inválida y conserva la ruta live únicamente cuando no existe intención de
fixture. Sustituye solo el comportamiento fail-open de ADR 0023 y complementa ADR 0024.

El propietario aceptó el ADR 0026 el 24 de agosto de 2026 tras dos revisiones independientes: fija iPhone portrait-only,
conserva iPad adaptativo y registra WCAG 1.3.4 como `A/No pasa — excepción de producto aceptada`. Sustituye únicamente
la decisión de orientación de ADR 0025 y excepciona de forma limitada la disposición de cierre de ADR 0022.
