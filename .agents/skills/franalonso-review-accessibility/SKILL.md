...
If no UI surface changed, return `N/A: sin alcance SwiftUI`. If the platform cannot create a fresh technically read-only
agent, report the gate as blocked; self-review is not equivalent independent evidence.
