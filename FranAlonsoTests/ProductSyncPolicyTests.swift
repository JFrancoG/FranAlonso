...
struct ProductSyncPolicyTests {
    ...
    func legacyBaseMustStillMatchItsExactSnapshot() {
        ...
        #expect(
            policy.decision(
                for: operation,
                against: ProductRemoteRecord(product: baseProduct, version: .legacy)
            ) == .apply(
                ProductRemoteRecord(
                    product: operation.product,
                    version: .versioned(revision: 1, lastOperationID: operation.operationID)
...
private func syncDeleteOperation(id: String, base: ProductRemoteBase) -> ProductPendingDelete {
    ProductPendingDelete(
        productID: UUID(uuidString: "50000000-0000-0000-0000-000000000001")!,
        operationID: syncUUID(id),
...
private func syncProduct(name: String) -> ProductDTO {
    ProductDTO(id: "50000000-0000-0000-0000-000000000001", name: name, status: .active)
}
